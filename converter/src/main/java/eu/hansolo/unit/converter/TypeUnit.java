...
// this was changed from Unit to TypeUnit to avoid confusion with the Unit class in Kotlin
public class TypeUnit {
    ...
    // ******************** Constructors **************************************
    public TypeUnit(final Category CATEGORY, final String UNIT_SHORT, final String UNIT_NAME, final double FACTOR) {
        this(CATEGORY, UNIT_SHORT, UNIT_NAME, FACTOR, 0.0);
    }
    public TypeUnit(final Category CATEGORY, final String UNIT_SHORT, final String UNIT_NAME, final double FACTOR, final boolean ACTIVE) {
        this(CATEGORY, UNIT_SHORT, UNIT_NAME, FACTOR, 0.0, ACTIVE);
    }
    public TypeUnit(final Category CATEGORY, final String UNIT_SHORT, final String UNIT_NAME, final BigDecimal FACTOR) {
        this(CATEGORY, UNIT_SHORT, UNIT_NAME, FACTOR, new BigDecimal("0.0"), true);
    }
    public TypeUnit(final Category CATEGORY, final String UNIT_SHORT, final String UNIT_NAME, final BigDecimal FACTOR, final boolean ACTIVE) {
        this(CATEGORY, UNIT_SHORT, UNIT_NAME, FACTOR, new BigDecimal("0.0"), ACTIVE);
    }
    public TypeUnit(final Category CATEGORY, final String UNIT_SHORT, final String UNIT_NAME, final double FACTOR, final double OFFSET) {
        this(CATEGORY, UNIT_SHORT, UNIT_NAME, new BigDecimal(Double.toString(FACTOR)), new BigDecimal(Double.toString(OFFSET)), true);
    }
    public TypeUnit(final Category CATEGORY, final String UNIT_SHORT, final String UNIT_NAME, final double FACTOR, final double OFFSET, final boolean ACTIVE) {
        this(CATEGORY, UNIT_SHORT, UNIT_NAME, new BigDecimal(Double.toString(FACTOR)), new BigDecimal(Double.toString(OFFSET)), ACTIVE);
    }
    public TypeUnit(final Category CATEGORY, final String UNIT_SHORT, final String UNIT_NAME, final BigDecimal FACTOR_BD, final BigDecimal OFFSET_BD) {
        this(CATEGORY, UNIT_SHORT, UNIT_NAME, FACTOR_BD, OFFSET_BD, true);
    }
    public TypeUnit(final Category CATEGORY, final String UNIT_SHORT, final String UNIT_NAME, final BigDecimal FACTOR_BD, final BigDecimal OFFSET_BD, final boolean ACTIVE) {
        category  = CATEGORY;
